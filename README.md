...
- Apply that rate structure to a set of hourly load profiles (like those from [ResStock](https://resstock.nrel.gov/))
  to calculate their utility bills, in either a baseline or upgrade scenario.
...
# Contributing
See [this page](CONTRIBUTING.md) for contribution guidelines.
